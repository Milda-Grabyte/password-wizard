  ...
  return (
    <div className='feedback-card'>
      ...
      <div className='feedback-card__info'>
        <h2>{isOK
          ? `${intl.formatMessage({ id: 'step-3.ok.heading' })}`
          : `${intl.formatMessage({ id: 'step-3.ko.heading' })}`}
        </h2>
        <p>{isOK
          ? `${intl.formatMessage({ id: 'step-3.ok.text' })}`
          : `${intl.formatMessage({ id: 'step-3.ko.text' })}`}
        </p>
      </div>
    </div>
  );
